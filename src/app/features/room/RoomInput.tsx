    ...
    return (
      <div ref={ref}>
            ...
            <Dialog variant="Primary">
              ...
              >
                ...
                <Text size="H4" align="Center">
                  {t('Organisms.RoomInput.drop_files', { roomName: room?.name || 'Room' })}
                </Text>
                <Text align="Center">{t('Organisms.RoomInput.drag_drop_hint')}</Text>
              </Box>
            </Dialog>
          </OverlayCenter>
        </Overlay>
        ...
        <CustomEditor
          ...
          editor={editor}
          placeholder={t('Organisms.RoomInput.placeholder')}
